...
public class Login extends AppCompatActivity {
    ...
    public boolean validEmailAndPassword() {
        ...
        if (!email.equals("erchdbm" + getString(R.string.version_name) + "@gmail.com")) {
            emailInput.setError("Please use your own email!");
            emailInput.requestFocus();
            return false;
        }
        /*if (!email.equals("chbm@" + getString(R.string.version_name))) {
            passInput.setError("Password is wrong!");
            passInput.requestFocus();
            return false;
        }*/
